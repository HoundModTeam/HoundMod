...
public class HoundOreBlock extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:houndore")
	public static final Block block = null;
	public HoundOreBlock(HoundmodModElements instance) {
		super(instance, 1);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("houndore", "houndore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 4), Placement.COUNT_RANGE, new CountRangeConfig(2, 0, 0, 10)));
		}
	}
}
