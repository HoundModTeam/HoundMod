...
public class HoundOreBlockBlock extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:houndoreblock")
	public static final Block block = null;
	public HoundOreBlockBlock(HoundmodModElements instance) {
		super(instance, 2);
	}
