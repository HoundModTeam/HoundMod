...
public class HardiumOreBlockBlock extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:hardiumoreblock")
	public static final Block block = null;
	public HardiumOreBlockBlock(HoundmodModElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hardiumoreblock");
		}
