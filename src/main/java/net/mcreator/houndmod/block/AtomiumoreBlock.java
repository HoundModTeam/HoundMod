...
public class AtomiumoreBlock extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:atomiumore")
	public static final Block block = null;
	public AtomiumoreBlock(HoundmodModElements instance) {
		super(instance, 46);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("atomiumore", "atomiumore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 5), Placement.COUNT_RANGE, new CountRangeConfig(1, 0, 0, 10)));
		}
	}
}
