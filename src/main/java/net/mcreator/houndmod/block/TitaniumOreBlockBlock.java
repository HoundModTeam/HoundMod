...
public class TitaniumOreBlockBlock extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:titaniumoreblock")
	public static final Block block = null;
	public TitaniumOreBlockBlock(HoundmodModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("titaniumoreblock");
		}
