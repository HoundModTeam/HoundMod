...
public class TitaniumOreBlock extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:titaniumore")
	public static final Block block = null;
	public TitaniumOreBlock(HoundmodModElements instance) {
		super(instance, 3);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 6), Placement.COUNT_RANGE, new CountRangeConfig(3, 1, 1, 15)));
		}
	}
}
