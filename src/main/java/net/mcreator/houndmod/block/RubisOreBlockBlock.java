...
public class RubisOreBlockBlock extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:rubisoreblock")
	public static final Block block = null;
	public RubisOreBlockBlock(HoundmodModElements instance) {
		super(instance, 6);
	}
