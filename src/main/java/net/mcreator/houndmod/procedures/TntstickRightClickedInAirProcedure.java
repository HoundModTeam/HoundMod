...
public class TntstickRightClickedInAirProcedure extends HoundmodModElements.ModElement {
	public TntstickRightClickedInAirProcedure(HoundmodModElements instance) {
		super(instance, 112);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure TntstickRightClickedInAir!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			System.err.println("Failed to load dependency itemstack for procedure TntstickRightClickedInAir!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure TntstickRightClickedInAir!");
			return;
		}
