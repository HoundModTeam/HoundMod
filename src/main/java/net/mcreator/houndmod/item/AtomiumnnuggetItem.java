...
public class AtomiumnnuggetItem extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:atomiumnnugget")
	public static final Item block = null;
	public AtomiumnnuggetItem(HoundmodModElements instance) {
		super(instance, 13);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("atomiumnnugget");
		}
