...
public class TitaniumHoeItem extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:titaniumhoe")
	public static final Item block = null;
	public TitaniumHoeItem(HoundmodModElements instance) {
		super(instance, 34);
	}
