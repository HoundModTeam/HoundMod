...
public class TitaniumSwordItem extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:titaniumsword")
	public static final Item block = null;
	public TitaniumSwordItem(HoundmodModElements instance) {
		super(instance, 17);
	}
	...
	public void initElements() {
		...
		}, 3, -3f, new Item.Properties().group(HoundModItemGroup.tab)) {
		}.setRegistryName("titaniumsword"));
	}
}
