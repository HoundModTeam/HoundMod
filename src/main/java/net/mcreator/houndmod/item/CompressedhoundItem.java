...
public class CompressedhoundItem extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:compressedhound")
	public static final Item block = null;
	public CompressedhoundItem(HoundmodModElements instance) {
		super(instance, 42);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("compressedhound");
		}
