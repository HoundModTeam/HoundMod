...
public class HoundstickItem extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:houndstick")
	public static final Item block = null;
	public HoundstickItem(HoundmodModElements instance) {
		super(instance, 41);
	}
