...
public class FireStickItem extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:firestick")
	public static final Item block = null;
	@ObjectHolder("houndmod:entitybulletfirestick")
	public static final EntityType arrow = null;
	public FireStickItem(HoundmodModElements instance) {
		super(instance, 25);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletfirestick").setRegistryName("entitybulletfirestick"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(HoundModItemGroup.tab).maxDamage(1000));
			setRegistryName("firestick");
		}
