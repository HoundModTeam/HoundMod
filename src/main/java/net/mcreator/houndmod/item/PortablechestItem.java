...
import net.mcreator.houndmod.gui.ChestGui;
...
public class PortablechestItem extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:portablechest")
	public static final Item block = null;
	public PortablechestItem(HoundmodModElements instance) {
		super(instance, 125);
	}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Portable chest");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new ChestGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
