...
public class RubisstickItem extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:rubisstick")
	public static final Item block = null;
	public RubisstickItem(HoundmodModElements instance) {
		super(instance, 43);
	}
