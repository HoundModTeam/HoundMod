...
public class HoundIngotItem extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:houndingot")
	public static final Item block = null;
	public HoundIngotItem(HoundmodModElements instance) {
		super(instance, 8);
	}
