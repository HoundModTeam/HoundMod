...
public class RubisShovelItem extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:rubisshovel")
	public static final Item block = null;
	public RubisShovelItem(HoundmodModElements instance) {
		super(instance, 37);
	}
