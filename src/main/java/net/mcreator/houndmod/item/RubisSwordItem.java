...
public class RubisSwordItem extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:rubissword")
	public static final Item block = null;
	public RubisSwordItem(HoundmodModElements instance) {
		super(instance, 19);
	}
