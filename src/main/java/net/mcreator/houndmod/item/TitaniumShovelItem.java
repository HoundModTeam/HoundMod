...
public class TitaniumShovelItem extends HoundmodModElements.ModElement {
	@ObjectHolder("houndmod:titaniumshovel")
	public static final Item block = null;
	public TitaniumShovelItem(HoundmodModElements instance) {
		super(instance, 33);
	}
